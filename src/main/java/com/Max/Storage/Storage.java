package com.Max.Storage;

import com.Max.Storage.bouquetsComponents.Decoration;
import com.Max.Storage.bouquetsComponents.flowers.*;
import com.Max.Storage.bouquetsComponents.leaves.*;
...
public class Storage implements Serializable {
    ...
    public void addFlower() {
        ...
        switch (in.nextInt()) {
            case 1:
                ...
                log.info("add Carnation");
                break;
            case 2:
                flower = new Chamomile();
                log.info("add Chamomile");
                break;
            case 3:
                flower = new Chrysanthemum();
                log.info("add Chrysanthemum");
                break;
            case 4:
                flower = new Orchid();
                log.info("add Orchid");
    ...
    public void sortFlowersByLength() {
        ...
        log.info("Sorting list of flowers...");
    ...
    public void changeFlower(int order) {
        if (order > flowers.size() || order < 0) {
            System.out.printf("\t\tFlower %d do not exists.\n", order);
            log.info("Flower do not exists");
            return;
        }
        System.out.printf("\t\tChanging %d flower:\n", order);
        log.info("Changing flower");
